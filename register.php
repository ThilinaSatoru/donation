...
if (isset($_POST["add"])) {
  ...
  $sql = "INSERT INTO donar (user_name, user_address, user_phone, user_email, user_user_name, user_password,user_type,gender,user_birthday) 
                VALUES ('$a', '$b', '$d', '$c', '$e', '$f', '$g', '$h', '$i');
            INSERT INTO donar_status (donar, health)
                VALUES (LAST_INSERT_ID(), 'Good');";
...
<body>
    ...
    <!-- home section starts <?php //echo $_SERVER['PHP_SELF']; ?>  -->
                ...
                <div class="content text-center text-md-left">
                    <form action="register.php" method="post">
                        ...
                        <form>
                            ...
                            <input type="text" id="Date_of_birth" name="Date_of_birth" placeholder="user birthday.."
                                required /><br /><br />
