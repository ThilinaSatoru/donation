        ...
        <div class="row min-vh-100 align-items-center">
          <div class="content text-center text-md-left">
            <iframe
              width="1500"
              height="800"
              src="https://www.youtube.com/embed/75HjFi4_r10"
...
<section class="process">
    ...
    <div class="box-container container">
        ...
        <div class="">
            <img src="images/organ-donation.jpg" alt="bgpicture" width="500" height="400">
            
        </div>

        <div class="box">
          <img src="images/banner.jpg" alt="bgpicture" width="500" height="400">
            
            </p>
        </div>

        <div class="box">
          <img src="images/eye-donation.jpg" alt="bgpicture" width="500" height="400">
